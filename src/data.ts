...
const myJobExp: JobExprience[] = [
  {
    ...
    location: "Hong Kong",
    descriptions: [
      "designed, developed and led a completely new project called Virtual Product Platform using NodeJS/Javascript, ReactJs, Redis hosted on AWS ECS and AWS Cloudfront with auto-scaling which serves around 80 global users daily, providing user a platform to review and manage their 3D development assets and products",
  ...
  },
  {
    ...
    location: "Hong Kong",
    descriptions: [
      "analysed, written guidelines and distributed tasks to 2-3 colleagues, and follow up with their progress",
  ...
  },
  {
    ...
    location: "Norway",
    descriptions: [
      "developed and maintained Assessment Management System in Java, HTML, CSS, Javascript, JSP, jquery, Ajax and XSL which helps users manage their assessments for their students in more than 50 educational  institutions globally",
  ...
  },
  {
    ...
    location: "Hong Kong",
    descriptions: [
      "assisted in teaching 100 students in programming in C++ and invigilated in mid-term test involving 100 students",
    ],
  },
  {
    workDuration: [
    ...
    location: "Hong Kong",
    descriptions: [
      "contacted 300 parents concerning information about 6 summer camps related to robotic programming",
  ...
  },
  {
    ...
    location: "Hong Kong",
    descriptions: [
      "prepared notes and taught 40 elderlies for the 5-day advanced computer class",
    ],
  },
  {
    workDuration: [
    ...
    location: "Hong Kong",
    descriptions: [
      "contacted with 7-8 customers as regular follow up",
